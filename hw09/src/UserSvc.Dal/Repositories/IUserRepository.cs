...
{
    Task<string> CreateUserAsync(User user, CancellationToken ct = default);
    ...
    Task UpdateUserAsync(string userId, User user, bool selfUpdate = true, CancellationToken ct = default);
