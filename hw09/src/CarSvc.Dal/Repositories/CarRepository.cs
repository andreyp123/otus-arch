    ...
    public class CarRepository : ICarRepository
    {
        ...
        private static Car MapCar(CarEntity ce)
        {
            return new Car
            {
                ...
                BodyStyle = Enum.Parse<CarBodyStyles>(ce.BodyStyle),
                DoorsCount = ce.DoorsCount,
                Transmission = Enum.Parse<CarTransmissionTypes>(ce.Transmission),
                FuelType = Enum.Parse<CarFuelTypes>(ce.FuelType),
